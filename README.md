...
* 可行性分析
  ...
  1. 成本问题
      ...
      ```txt
      选用砖石箭塔，成本低廉的同时兼具威力。只需要铜锭、铁锭、铁矿和草绳等低级资源，且数量要求少，可以毫不费力的生产出大量界碑，砖石箭塔和哨箭。但是要拆就没那么容易了，攻城器械别说成本，制作时间就非常长，特别是弹药。两相对比，材料成本完全是以一换十换百，时间成本更是不成正比。

  2. 被拆了怎么处理

      ```txt
      不要浪费时间精力守，这个就是给他们拆的，不拆都不行，以此消耗时间精力，界碑没了直接原地或换个地方加箭塔再起，砖石箭塔不管被拆没被拆都不用管，不拆就留在那继续射几个小时。
      ```
